    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-bg-950/95 backdrop-blur-xl border-b border-border" : "bg-transparent"}`}>
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        <nav className="hidden md:flex items-center gap-1.5">
          <Link href="/" className="px-5 py-2 bg-white/5 border border-white/5 text-sm font-semibold text-text-secondary hover:text-white hover:bg-white/10 hover:border-white/10 rounded transition-all">Home</Link>
          <Link href="/about" className="px-5 py-2 bg-white/5 border border-white/5 text-sm font-semibold text-text-secondary hover:text-white hover:bg-white/10 hover:border-white/10 rounded transition-all">About</Link>
          <Link href="/services" className="px-5 py-2 bg-white/5 border border-white/5 text-sm font-semibold text-text-secondary hover:text-white hover:bg-white/10 hover:border-white/10 rounded transition-all">Services</Link>
          <Link href="/contact" className="px-5 py-2 bg-white/5 border border-white/5 text-sm font-semibold text-text-secondary hover:text-white hover:bg-white/10 hover:border-white/10 rounded transition-all">Contact</Link>
        </nav>
