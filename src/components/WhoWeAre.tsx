      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            {/* Stat cards — now clean inline grid below the text */}
            <div className="mt-10 grid grid-cols-2 gap-4">
              <div className="bg-bg-800 border border-border rounded-xl p-5">
                <Shield className="w-5 h-5 text-red-500 mb-2" />
                <p className="text-xl font-bold text-white">IICRC</p>
                <p className="text-xs text-text-tertiary">Certified Firm</p>
              </div>
              <div className="bg-bg-800 border border-border rounded-xl p-5">
                <Users className="w-5 h-5 text-red-500 mb-2" />
                <p className="text-xl font-bold text-white">2012</p>
                <p className="text-xs text-text-tertiary">Family Owned</p>
              </div>
            </div>
          </div>

          {/* Image side */}
          <div className="aspect-[4/5] rounded-2xl bg-bg-800 border border-border relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-tr from-black/30 to-transparent flex items-end justify-start p-6">
              <div className="px-3 py-1.5 bg-bg-900 text-white text-xs font-semibold rounded-lg border border-border">On The Job</div>
            </div>
          </div>
        </div>
      </div>
